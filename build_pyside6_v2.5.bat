...
echo == Building single-file exe (PySide6 v2.5) ==
"%PYINSTALLER%" --noconfirm --onefile --windowed --name ScreenRecorder --icon "assets\icon.ico" --add-binary "ffmpeg.exe;." --add-data "assets\icon.png;assets" --collect-all PySide6 screen_recorder_pyside6_v2.5.py
